...
fn validates_iana_timezone_and_derives_local_dates_across_dst() {
    ...
    assert_eq!(
        eastern
            .local_today_at(datetime!(2026-03-08 04:30 UTC))
            .unwrap(),
        date!(2026 - 03 - 07),
    ...
    assert_eq!(
        eastern
            .local_today_at(datetime!(2026-03-08 07:30 UTC))
            .unwrap(),
        date!(2026 - 03 - 08),
    );
    assert_eq!(
        eastern
            .local_today_at(datetime!(2026-11-01 03:30 UTC))
            .unwrap(),
        date!(2026 - 10 - 31),
    ...
    assert_eq!(
        eastern
            .local_today_at(datetime!(2026-11-01 06:30 UTC))
            .unwrap(),
        date!(2026 - 11 - 01),
    );
}
